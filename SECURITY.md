...
This library moves application messages (including RPC payloads and dead-letter
data), so a vulnerability here can affect downstream Bitrix24 integrations.
